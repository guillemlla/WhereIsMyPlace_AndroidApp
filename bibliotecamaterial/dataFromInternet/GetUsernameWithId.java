...
public class GetUsernameWithId extends AsyncTask<String,Object,String> {



    public AsyncResponse delegate = null;//Call back interface

    public GetUsernameWithId(AsyncResponse asyncResponse){
    ...
    protected String doInBackground(String... strings) {
        //strings[0] = idUser
        URL myFileUrl = null;
        String urlString = "http://"+ Principal.ip + "/php/getUsername.php?idUser="+strings[0];
        try {
