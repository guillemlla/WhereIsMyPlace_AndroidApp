...
public class ConfirmaConnexio extends AsyncTask<String[],Object,String> {



    public AsyncResponse delegate = null;//Call back interface

    public ConfirmaConnexio(AsyncResponse asyncResponse){
    ...
    protected String doInBackground(String[]... strings) {
        ...
        String urlString = "http://"+ Principal.ip + "/php/acceptConnection.php?username1="+username1+"&username2="+username2;
        try {
